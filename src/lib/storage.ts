...
export const INITIAL_SAMPLE_STAMPS: StampItem[] = [
  {
    id: 'stamp-1',
    title: 'Coliseo al Atardecer',
    kanjiTitle: 'ROMA POSTE',
    date: '2026-07-05',
    category: 'Naturaleza',
    imageUrl: createSampleImage('COLISEO ROMANO', '#EFECE6', '#556B2F', '🏛️'),
    filterStyle: 'sepia',
    denomination: '€0,80',
    postmarkCity: 'ROMA',
    postmarkStyle: 'classic',
    frameColor: '#F4EFE6',
    notes: 'Paseo matutino rodeando el Coliseo con la luz Dorada de Roma.',
    orderIndex: 0,
    createdAt: Date.now() - 86400000 * 20,
  },
  {
    id: 'stamp-2',
    title: 'Café en Piazza Duomo',
    kanjiTitle: 'MILANO',
    date: '2026-07-12',
    category: 'Gastronomía',
    imageUrl: createSampleImage('CAFE EN MILANO', '#F2EFE9', '#C8372D', '☕'),
    filterStyle: 'risograph',
    denomination: '€1,20',
    postmarkCity: 'MILANO',
    postmarkStyle: 'doubleRing',
    frameColor: '#EAE5D9',
    notes: 'Espresso italiano matutino contemplando el Duomo.',
    orderIndex: 1,
  ...
  },
  {
    ...
    date: '2026-07-18',
    category: 'Momentos',
    imageUrl: createSampleImage('CANALES VENECIA', '#EAE6DF', '#1E293B', '🛶'),
    filterStyle: 'ukiyoe',
    denomination: '',
    postmarkCity: 'VENEZIA',
    postmarkStyle: 'seal',
    frameColor: '#F7F3EB',
    notes: 'Atardecer navegando entre los palacios históricos.',
    orderIndex: 2,
    createdAt: Date.now() - 86400000 * 10,
  },
  {
    id: 'stamp-4',
    title: 'Atardecer en Florencia',
    kanjiTitle: 'FIRENZE',
    date: '2026-07-24',
    category: 'Momentos',
    imageUrl: createSampleImage('PONTE VECCHIO', '#F0EDE6', '#78350F', '🌅'),
    filterStyle: 'halftone',
    denomination: '€0,90',
    postmarkCity: 'FIRENZE',
    postmarkStyle: 'minimal',
    frameColor: '#F5F1E8',
    notes: 'Mirador de Piazzale Michelangelo al ponerse el sol.',
    orderIndex: 3,
  ...
  },
  {
    ...
    date: '2026-07-28',
    category: 'Viajes',
    imageUrl: createSampleImage('AMALFI COAST', '#EBE7DE', '#D97706', '🌊'),
    filterStyle: 'retroGrain',
    denomination: '',
    postmarkCity: 'AMALFI',
    postmarkStyle: 'classic',
    frameColor: '#FAF5E8',
    notes: 'Vistas panorámicas del mar Tirreno.',
    orderIndex: 4,
